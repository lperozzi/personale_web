...
The app is hosted on GitHub [here](https://github.com/lperozzi/Spatial_interpolation_app)  and deployed on Heroku at this address [https://spatial-interpolation.herokuapp.com/](https://spatial-interpolation.herokuapp.com/). Be patient, it takes few second to wake app the Heroku dynos 🤞🤞.
...
🚀🚀 Let's explore all the interpolated surfaces interactively in 3D through this [app](https://spatial-interpolation.herokuapp.com/) (Be patient, it takes few second to wake app the Heroku dynos).  🚀🚀
