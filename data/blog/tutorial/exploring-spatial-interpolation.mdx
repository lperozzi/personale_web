...
![dash](/static/images/tutorial/interpolation/interpolation.png)
...
```
![biharmonic spline interpolation (default)](/static/images/tutorial/interpolation/spline.def.png)
...
```
![biharmonic spline interpolation (cross-validated)](/static/images/tutorial/interpolation/spline_cv.png)
...
![Gaussian Processes interpolation](/static/images/tutorial/interpolation/GP.png)
...
![Kriging interpolation](/static/images/tutorial/interpolation/OK.png)
...
![SGS realization](/static/images/tutorial/interpolation/real.png)
...
![E-type and conditional variance](/static/images/tutorial/interpolation/etype.png)
...
![Local percentiles](/static/images/tutorial/interpolation/percent.png)
...
🚀🚀 Let's explore all the interpolated surfaces interactively in this [app](https://spatial-interpolation.herokuapp.com/
...
### Data analytics
- Youtube channel of GeostatGuy lectures:   
https://www.youtube.com/GeostatsGuyLectures
- Github of GeostatGuy with a lot, really a lot of high level resource in data analytics, Geostatistics and Machine Learning :  
https://github.com/GeostatsGuy
- Fatiando a Terra - Fatiando provides Python libraries for data processing, modeling, and inversion across the Geosciences:
...
- A journey into Plotly Dash:
https://www.geomaap.io/blog/tutorial/dash-tutorial
